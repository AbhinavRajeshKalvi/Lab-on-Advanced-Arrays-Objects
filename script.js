...
const concatenatedAlphabets = alphabets.reduce((accumulator, current) => accumulator + current, '');
...
const travelInfo = `Mr ${person.name} travels by plane called ${person.vehicles['plane']}`;
